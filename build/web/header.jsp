	...
	<link rel="stylesheet" href="css/main.css">
        ...
        <script>
            function updateSearchQuery(event) {
                ...
                var query = encodeURIComponent(searchInput.trim());
            ...
            function fetchSuggestions() {
                ...
                if (input.length > 0) {
                    ...
                    const url = 'searchSuggestions.jsp?query=' + encodeURIComponent(input);
...
<body>
	...
	<header class="header_area sticky-header">
			...
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					<!-- Brand and toggle get grouped for better mobile display -->
                                        <a class="navbar-brand logo_h" href="index.jsp">eShop</a>
		...
		<div class="search_input" id="search_input_box">
                    <div class="container">
                        <form class="d-flex justify-content-between" onsubmit="updateSearchQuery(event)">
                            <input type="text" class="form-control" id="search_input" placeholder="Search Here" oninput="fetchSuggestions()">
